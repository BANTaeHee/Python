'''
    1. Intelligence(지능)
        ...
        3) 프로그램 : 문제를 해결할때 따라야 하는 일들을 지시하는 것
        4) 컴퓨터가 스스로 방법을 찾아냄 : 데이터를 기반으로 스스로 학습할 수 있음
            - 알파고 : 컴퓨터에 바둑 경기의 규칙과 이전 경기의 맣은 데이터를 알려줌.
    ...
    2.  Articficial Intelligence(인공 지능)
        1) 인간의 학습 능력과 추론, 지각 능력을 인공적으로 구현한 것
            - 인간처럼 사고하기, 인간처럼 행동하기, 합리적으로 사고하기, 합리적으로 행동하기
        2) 머신 러닝 (Machine learning)은 매루 구체적이고 엄밀한 정의를 가지고 있음.
    ...
    3. 머신러닝 종류
        1) 지도학습 (supervised learning)
            ...
            - Ex.  고양이, 개를 구분할 때 고양이인지 개인지 레이블링 된 데이터를 충분히 제공한 뒤에
                    학습을 하도록하는 과정이 필요
                    - 학습 단계 => 예측모델 => 테스트 단계
    ...
    4. 회귀분석
        ...
        2) 회귀분석
            ...
            - 주택의 면적이 큰 경우 판매가격도 높은 경우가 많음
                ...
                - 이 둘 사이 상관관계를 1차 방정식으로 표현 될 수 있는 선형관계라고 함
                    - 주택 면적 x와 거래가격 y의 관계는 y = wx +b로 표현됨.
                    - 기울기 w 과 절편 b 를 어떻게 정의하는가에 따라 표현 할 수 있음
